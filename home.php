...
$recommendations = "SELECT p.*, 
                   ...
                   WHERE p.type IN ('Uniform', 'Supplies')
                   GROUP BY p.id, p.product_name, p.price, p.image, p.type, p.rating, p.tags
                   ORDER BY RAND()
                   LIMIT 8";

$stmt = $conn->prepare($recommendations);
$stmt->bind_param("i", $user_id);
$stmt->execute();
...
<body>
    ...
    <div class="container text-start p-md-5 margin fade-section">
        ...
        <div class="year-level row g-4 justify-content-center">
            <!-- First Row -->
            <div class="col-md-6">
                <a href="shop_uniforms.php"><img src="admin/images/Home Page/Pre-School & Elementary.png"
                        class="img-fluid rounded shadow" alt="Pre-School & Elementary"></a>
            </div>
            <div class="col-md-6">
                <a href="shop_uniforms.php"><img src="admin/images/Home Page/Junior High School.png"
                        class="img-fluid rounded shadow" alt="Junior High"></a>
            </div>
            <!-- Second Row -->
            <div class="col-md-6">
                <a href="shop_uniforms.php"><img src="admin/images/Home Page/Senior High School.png"
                        class="img-fluid rounded shadow" alt="Senior High"></a>
            </div>
            <div class="col-md-6">
                <a href="shop_uniforms.php"><img src="admin/images/Home Page/College.png"
                        class="img-fluid rounded shadow" alt="College"></a>
            </div>
        </div>
    </div>
                            ...
                            <div class="product-card d-flex flex-column w-100" style="height:100%; cursor:default;">
                                ...
                                <div class="product-info d-flex flex-column flex-grow-1">
                                    ...
                                    <?php if (!empty($rec_row['genders'])): ?>
                                        <p class="mb-1">
                                            <?php
                                            $genders = explode(',', $rec_row['genders']);
                                    ...
                                    <div class="icon-buttons">
                                        <button class="fav-button <?= $rec_row['is_favorited'] ? 'active' : '' ?>"
                                            ...
                                            <i class="bi <?= $rec_row['is_favorited'] ? 'bi-heart-fill' : 'bi-heart' ?>"></i>
                                        </button>
                                        <button class="basket-button"
                                            onclick="event.stopPropagation(); addToBasket(<?= $rec_row['id'] ?>, '<?= htmlspecialchars($rec_row['product_name']) ?>', <?= $rec_row['price'] ?>, '<?= htmlspecialchars($rec_row['image']) ?>')">
            ...
            <div class="accordion" id="faqAccordion">
                ...
                <div class="accordion-item">
                    ...
                    <div id="answer1" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            The website offers a variety of official uniforms, which you can easily filter based on your
                            year level to find exactly what you need.
                            You’ll also find a selection of school supplies and other school-related merchandise
                            designed for the VMC community.
                        </div>
                    </div>
                </div>
                <!-- Question 2 -->
                <div class="accordion-item">
                    ...
                    <div id="answer2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            Log in to your VMC Basket account using your registered student number and password. Browse
                            through the available merchandise in the “Shop” section,
                            select the items you need, and add them to your cart. Once ready, proceed to checkout and
                            choose your preferred payment method and upload your E-receipt.
                ...
                <div class="accordion-item">
                    ...
                    <div id="answer3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            VMC Basket accepts both over-the-counter and online payments.<br><br> For over-the-counter
                            payments, you can pay directly at the VMC Accounting Office after placing your order
                            online.<br><br>
                            For online payments, you may choose GCash at checkout. Send the total amount to the official
                            VMC Basket GCash number, then upload a screenshot or photo of your payment receipt during
                            checkout. This allows the admin to verify your payment and ensures your order is processed
                            smoothly
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="answer4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            VMC Basket does not offer door-to-door delivery at this time. All orders must be claimed
                            physically at the school's bookstore.
                            This ensures that students and parents can personally check their orders upon claiming and
                            helps maintain smooth and organized distribution within the campus.
                        </div>
                    </div>
                </div>
                <!-- Question 5 -->
                <div class="accordion-item">
                    ...
                    <div id="answer5" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            Once your order has been verified and confirmed by the admin team, it will be marked as “To
                            Pick Up” in the “My Purchase” section of your account. You will also receive an order
                            summary with all relevant pickup instructions and details.
                        </div>
                    </div>
                </div>
                ...
                <div id="faqMore" style="display:none;">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="answer6" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                Yes, you can cancel your order as long as it has not yet been processed or verified by
                                the admin. Simply go to the “My Purchase” section, locate the order, and choose the
                                cancel option. Once an order has been verified, it can no longer be canceled.
                            </div>
                        </div>
                    </div>
                    <!-- Question 7 -->
                    <div class="accordion-item">
                        ...
                        <div id="answer7" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                No. The VMC Basket is exclusively for currently enrolled students and official staff of
                                Villagers Montessori College. Only administrators can register users, and each account
                                is tied to a valid VMC student number.
                            </div>
                        </div>
                    </div>
                    <!-- Question 8 -->
                    <div class="accordion-item">
                        ...
                        <div id="answer8" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                Yes. The platform is designed with data security in mind. Only administrators can create
                                accounts, and sensitive details such as your full name and student number cannot be
                                edited after registration. All user data is stored securely and handled with strict
                                confidentiality.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="answer9" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                Not at this time. The VMC Basket is a web-based platform optimized for use on desktop
                                and mobile browsers. You can conveniently access it via any modern browser on your
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="answer10" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                If you forget your password, simply click on the “Forgot Password” option on the login
                                page. Enter your email address, and a One-Time Password (OTP) will be sent to your
                                registered email address. Use the OTP to verify your identity and reset your password
                                securely.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="answer11" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                Yes, you can update select details such as your phone number, email address, birthdate,
                                and year level by visiting the Account Settings page. However, your full name and
                                student number are locked for identity verification purposes and cannot be edited.
                            </div>
                        </div>
                    </div>
                    <!-- Question 12 -->
                    <div class="accordion-item">
                        ...
                        <div id="answer12" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                Yes! After you've received your order, you can go to the My Purchase page to leave a
                                star rating, write a review, and upload a photo of the item. </div>
                        </div>
                    </div>
                    <!-- Question 13 -->
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="faq13">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#answer13">
                                Can I request customized uniform sizes?
                            </button>
                        </h2>
                        <div id="answer13" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                No. We currently do not accept custom uniform size requests. Only the standard sizes
                                listed on the site are available for purchase. </div>
                        </div>
                    </div>
                    <!-- Question 14 -->
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="faq14">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#answer14">
                                Can I return a product after receiving it?
                            </button>
                        </h2>
                        <div id="answer14" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                Yes, you may request a return if the product meets our return policy conditions. To do
                                this, go to the “My Purchase” section, locate the order, and select the Return option.
                                Please provide the reason for the return and upload photos of the product you want to
                                return, then click Send Request. Our team will review your request and let you know if
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="answer15" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                If you can’t find the answer you’re looking for, simply use the chat feature on our
                                website to talk directly with an admin for real-time assistance.
                            </div>
                        </div>
                    </div>
                </div>
