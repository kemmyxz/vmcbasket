                ...
                <div class="collapse d-md-block" id="filterCollapse">
                    ...
                    <div class="mb-4 mt-3">
                        ...
                        <ul class="list-unstyled filter-text">
                            <li><input type="radio" name="year_level_basic" class="form-check-input me-2">Writing Tools</li>
                            <li><input type="radio" name="year_level_basic" class="form-check-input me-2">Paper Products</li>
                            <li><input type="radio" name="year_level_basic" class="form-check-input me-2">Art Supplies</li>
                        </ul>
                    </div>
                </div>
            </aside>
