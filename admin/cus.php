          ...
          <div class="col-12 col-md">
            <form class="d-flex flex-column flex-sm-row align-items-stretch align-items-sm-center" method="get" action="cus.php" style="gap: 8px;">
              <div class="d-flex flex-column flex-sm-row align-items-stretch align-items-sm-center w-100">
                <label for="from_year" class="form-label mb-1 mb-sm-0 me-sm-1" style="font-size: 15px;"><strong>From S.Y.</strong></label>
                <input type="number" class="form-control date-filter mb-2 mb-sm-0" id="from_year" name="from_year" min="1900" max="<?= date('Y'); ?>" value="<?= htmlspecialchars($_GET['from_year'] ?? '') ?>" placeholder="Year">
                <label for="to_year" class="form-label mb-1 mb-sm-0 ms-sm-2 me-sm-1" style="font-size: 15px;"><strong>To</strong></label>
                <input type="number" class="form-control date-filter mb-2 mb-sm-0" id="to_year" name="to_year" min="1900" max="<?= date('Y'); ?>" value="<?= htmlspecialchars($_GET['to_year'] ?? '') ?>" placeholder="Year">
