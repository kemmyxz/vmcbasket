    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse" style="position: fixed;">
                ...
                <a href="ratings.php" class="mt-2 active"><img src="./images/Admin Nav/rating-nav-clicked.png" alt="Ratings & Reviews" Class="reviews-icon" style="max-width: 30px; margin-right: 10px;">Ratings & Reviews</a>
