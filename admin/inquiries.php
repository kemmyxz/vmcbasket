...
<body>
    <div class="container-fluid">
      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse"  style="position: fixed;">
        ...
        <a href="inquiries.php" class="mt-2 active"><img src="./images/Admin Nav/message-nav-clicked.png" alt="Message" class="message-icon" style="max-width: 30px; margin-right: 10px;">Messages</a>
