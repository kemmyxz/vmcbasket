    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse"  style="position: fixed;">
                ...
                <a href="#" class="mt-2"><img src="./images/Admin Nav/message-nav.png" alt="Message" class="message-icon" style="max-width: 30px; margin-right: 10px;">Messages</a>
                ...
                <a href="accounting.php" class="mt-2 mb-2 active"><img src="./images/Admin Nav/receipt-nav-clicked 1.png" alt="Accounting" Class="accounting-icon" style="max-width: 30px; margin-right: 10px;">Receipt Form</a>
